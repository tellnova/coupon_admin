            ...
            d = a.sDom.split(""), g, f, h, e, s, m, o, k = 0; k < d.length; k++) {
                ...
                if ("<" == h) {
                    ...
                    if ("'" == s || '"' == s) {
                        ...
                        o++;
                        "H" == m ? m = a.oClasses.sJUIHeader: "F" == m && (m = a.oClasses.sJUIFooter); - 1 != m.indexOf(".") ? (s = m.split("."), e.id = s[0].substr(1, s[0].length - 1), e.className = s[1]) : "#" == m.charAt(0) ? e.id = m.substr(1, m.length - 1) : e.className = m; //NOVA
                        k += o
                    }
                    c.appendChild(e);
                    c = e
...
//            sInfo: "Showing _START_ to _END_ of _TOTAL_ entries",
            sInfo: "共 _TOTAL_ 项，本页显示第 _START_ 到第 _END_ 项",
            sInfoEmpty: "共 0 项，显示第 0 项到第 0 项",
